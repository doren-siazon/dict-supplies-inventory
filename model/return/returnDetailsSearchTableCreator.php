<?php
	...
	$output = '<table id="returnDetailsTable" class="table table-sm table-striped table-bordered table-hover" style="width:100%">
				<thead>
					<tr>
						<th style="text-align:center">Return ID</th>
						<th style="text-align:center">Item Number<br><br> (or Serial Number)</th>
