		...
		<div class="row">
			...
			<div class="col-lg-10">
				<div class="tab-content" id="v-pills-tabContent">
										...
										<form>
											<div class="form-row">
												...
												<div class="form-group col-md-3">
													...
													<input type="date" class="form-control datepicker" id="replenishDetailsreplenishDate" name="replenishDetailsreplenishDate" readonly value="">
												</div>
												<div class="form-group col-md-2">
													<label for="replenishDetailsreplenishID">Replenish ID</label>
													<input type="text" class="form-control invTooltip" id="replenishDetailsreplenishID" name="replenishDetailsreplenishID" title="This will be auto-generated when you add a new record" autocomplete="off">
										...
										<form>
											<div class="form-row">
												<div class="form-group col-md-2">
													...
													<input type="text" class="form-control invTooltip" id="requestorDetailsrequestorID" name="requestorDetailsrequestorID" title="This will be auto-generated when you add a new requestor" autocomplete="off">
					...
					<div class="tab-pane" id="v-pills-administrative" role="tabpanel" aria-labelledby="v-pills-administrative-tab">
						<div class="card card-outline-secondary my-4">
							<div class="card-header">Administrative Settings</div>
							<div class="card-body">
								<ul class="nav nav-tabs" role="tablist">
									<li class="nav-item">
